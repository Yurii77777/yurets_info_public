...
const productsVarioComUa = require("../data/productsVarioComUa");

const varioComUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsVarioComUa;
    let data = [];
