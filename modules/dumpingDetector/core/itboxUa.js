...
const productsItboxUa = require("../data/productsItboxUa");

const itboxUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsItboxUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            try {
                const isInStock = await page.$eval(".stuff-stock", (text) =>
