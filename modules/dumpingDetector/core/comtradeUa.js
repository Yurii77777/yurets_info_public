...
const productsComtradeUa = require("../data/productsComtradeUa");

const comtradeUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsComtradeUa;
    let data = [];
