...
const productsClickUa = require("../data/productsClickUa");

const clickUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsClickUa;
    let data = [];
