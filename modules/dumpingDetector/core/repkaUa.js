...
const productsRepkaUa = require("../data/productsRepkaUa");

const repkaUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsRepkaUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            try {
                const isInStock = await page.$eval(".available_text", (text) =>
