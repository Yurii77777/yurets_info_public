...
const productsProdavakaUa = require("../data/productsProdavakaUa");

const prodavakaUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsProdavakaUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            await page.waitForSelector(".kartochka_2");
