...
const productsOptmagComUa = require("../data/productsOptmagComUa");

const optmagComUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsOptmagComUa;
    let data = [];
