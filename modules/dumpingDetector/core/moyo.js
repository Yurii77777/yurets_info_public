...
const productsMoyo = require("../data/productsMoyo");

const moyo = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsMoyo;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            try {
                ...
                isInStock === "Є в наявності" || isInStock === "Закінчується"
