...
const productsCamertonComUa = require("../data/productsCamertonComUa");

const CamertonComUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsCamertonComUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            await page.waitForSelector(".b-page__row");
