...
const productsEnkoComUa = require("../data/productsEnkoComUa");

const enkoComUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsEnkoComUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            await page.waitForSelector(".tmain");
