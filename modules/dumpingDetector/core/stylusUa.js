...
const productsStylusUa = require("../data/productsStylusUa");

const stylusUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsStylusUa;
    let data = [];
