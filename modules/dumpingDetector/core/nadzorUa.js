...
const productsNadzorUa = require("../data/productsNadzorUa");

const nadzorUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsNadzorUa;
    let data = [];
