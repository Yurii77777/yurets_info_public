...
const productsSmartipComUa = require("../data/productsSmartipComUa");

const smartipComUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsSmartipComUa;
    let data = [];
