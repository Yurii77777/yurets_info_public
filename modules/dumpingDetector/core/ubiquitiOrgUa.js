...
const productsUbiquitiOrgUa = require("../data/productsUbiquitiOrgUa");

const ubiquitiOrgUa = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsUbiquitiOrgUa;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            await page.waitForSelector(".b-container");
