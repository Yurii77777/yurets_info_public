...
const productsMegamarket = require("../data/productsMegamarket");

const megamarket = async (options) => {
    const { browser, sellerName, currentFullDate } = options;
    const { sellerProducts, sellerUrl } = productsMegamarket;
    let data = [];
    ...
    const scrapeCurrentPage = async (
        ...
        try {
            ...
            await page.waitForSelector(".page_wrapper");
            ...
            try {
                dataObj["currentPrice"] = await page.$eval(".price", (text) =>
